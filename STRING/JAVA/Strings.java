class Strings
{
    public static void main(String[] args)
    {
        ...
        //isEmpty()
        System.out.println("isEmpty():\t\t\t" + trial.isEmpty());
        ...
        //equalsIgnoreCase()
        System.out.println("equalsIgnoreCase(\"Hello World this is github\"):\t" + trial.equalsIgnoreCase("hello world this is github"));
